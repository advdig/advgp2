...
public class ArchivosUtil {
    ...
    public static boolean existeConexion(String wse, String wsa) {
        ...
        while (i < 1) {
            ...
            try {
                ...
                EnvioComprobantesWS ws = new EnvioComprobantesWS(wse);
    ...
    public static boolean existeConexion(String wse, String wsa, boolean mantenimiento) {
        int i = 0;
        boolean respuesta = false;
            ...
            while (i < 1) {
                ...
                try {
                    ...
                    if (obj == null) {
                        ...
                        respuestaC = (new AutorizacionComprobantesWS("https://cel.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantes")).llamadaWSAutorizacionInd("0000000");
