 ...
 */
public class HiloHijo implements Callable<String> {
    ...
    public HiloHijo(DataSource data, String Ewsri, String Awsri, File factura, int idfactura, String clave, String numero) {
        this.Ewsri = Ewsri;
        this.Awsri = Awsri;
